...
export function SearchPanel({ open, onClose }: SearchPanelProps) {
  ...
  return (
    <div
      className="search-panel absolute inset-0 z-[60] overflow-y-auto overscroll-y-contain bg-ocean-900 text-on-dark scrollbar-none [-webkit-overflow-scrolling:touch]"
      role="dialog"
      aria-modal="true"
      aria-label="Recherche"
    >
      <div className="search-panel-inner flex min-h-full flex-col">
        <div className="search-panel-toolbar flex h-[4.5rem] shrink-0 items-center justify-end px-section">
          <button
            type="button"
        ...
        <div className="search-panel-body flex flex-col gap-10 px-8 pb-8">
          <div className="search-panel-layout flex flex-col gap-10">
            <section
              className="search-panel-primary flex flex-col gap-6"
            ...
            >
              ...
              <form
                className="search-panel-form flex h-12 w-full items-center rounded-full border-2 border-glaz-100 bg-background pl-4 pr-2 transition-[border-color] focus-within:border-ocean-300"
              ...
              <ul className="search-panel-help-links flex flex-col gap-4 pl-2">
            ...
            <div
              className="search-panel-divider h-px w-full bg-on-dark/40"
              aria-hidden
            />

            <section
              className="search-panel-resources flex flex-col gap-6"
            ...
            >
              ...
              <ul className="search-panel-resource-list flex flex-col gap-6 pl-2">
                {EXTERNAL_RESOURCES.map((item) => (
                  <li key={item.label}>
                    <a
                      ...
                      className="search-panel-resource-card flex flex-col gap-1"
                    >
